...
com.cognitect.transit.eq.hashCode = function(a) {
  ...
  switch(typeof a) {
    ...
    default:
      ...
      if (com.cognitect.transit.util.isArray(a)) {
        return com.cognitect.transit.eq.hashArrayLike(a);
      }
      if (a.com$cognitect$transit$hashCode) {
        return a.com$cognitect$transit$hashCode();
      }
      if (a[com.cognitect.transit.eq.transitHashCodeProperty]) {
        return a[com.cognitect.transit.eq.transitHashCodeProperty];
      }
      var b = com.cognitect.transit.eq.hashMapLike(a);
      return a[com.cognitect.transit.eq.transitHashCodeProperty] = b;
  }
};
...
com.cognitect.transit.types.isInteger = function(a) {
  return a instanceof goog.math.Long;
};
...
com.cognitect.transit.types.BigInteger.prototype.toString = function() {
  return "[BigInteger: " + this.value + "]";
};
com.cognitect.transit.types.BigInteger.prototype.com$cognitect$transit$equals = function(a) {
  return a instanceof com.cognitect.transit.types.BigInteger && this.value === a.value;
};
com.cognitect.transit.types.BigInteger.prototype.com$cognitect$transit$hashCode = function() {
  return com.cognitect.transit.eq.hashCode(this.value);
};
com.cognitect.transit.types.bigInteger = function(a) {
  return new com.cognitect.transit.types.BigInteger(a);
};
com.cognitect.transit.types.BigDecimal = function(a) {
  this.value = a;
};
com.cognitect.transit.types.BigDecimal.prototype.toString = function() {
  return "[BigDecimal: " + this.value + "]";
};
com.cognitect.transit.types.bigDecimalValue = function(a) {
  return new com.cognitect.transit.types.BigDecimal(a);
};
com.cognitect.transit.types.isBigDecimal = function(a) {
  return a instanceof com.cognitect.transit.types.BigDecimal;
};
...
com.cognitect.transit.types.UUID.prototype.com$cognitecat$transit$hashCode = function() {
  -1 === this.hashCode && (this.hashCode = com.cognitect.transit.eq.hashCode(this.toString()));
  return this.hashCode;
};
com.cognitect.transit.types.randomUUID = function() {
};
...
com.cognitect.transit.types.binary = function(a) {
  return new com.cognitect.transit.types.Binary(a);
};
com.cognitect.transit.types.isBinary = function(a) {
  return a instanceof com.cognitect.transit.types.Binary;
};
com.cognitect.transit.types.URI = function(a) {
  this.uri = a;
};
com.cognitect.transit.types.URI.prototype.toString = function() {
  return "[URI: " + this.uri + "]";
};
com.cognitect.transit.types.uri = function(a) {
  return new com.cognitect.transit.types.URI(a);
};
com.cognitect.transit.types.isURI = function(a) {
  return a instanceof com.cognitect.transit.types.URI;
};
com.cognitect.transit.types.ints = function(a) {
  return a;
};
com.cognitect.transit.types.longs = function(a) {
  return a;
};
com.cognitect.transit.types.floats = function(a) {
  return a;
};
com.cognitect.transit.types.doubles = function(a) {
  return a;
};
com.cognitect.transit.types.bools = function(a) {
  return a;
};
...
com.cognitect.transit.types.TransitArrayMap.prototype.com$cognitect$transit$hashCode = function() {
  return this.backingMap ? this.backingMap.com$cognitect$transit$hashCode() : -1 != this.hashCode ? this.hashCode : this.hashCode = com.cognitect.transit.eq.hashMapLike(this);
};
...
com.cognitect.transit.types.TransitMap.prototype.com$cognitect$transit$hashCode = function() {
  return-1 != this.hashCode ? this.hashCode : this.hashCode = com.cognitect.transit.eq.hashMapLike(this);
};
...
com.cognitect.transit.types.TransitSet.prototype.add = function(a) {
  throw Error("Unsupported operation: add");
};
...
com.cognitect.transit.types.Quote = function(a) {
  this.obj = a;
};
com.cognitect.transit.types.Quote.prototype.toString = function() {
  return "[Quoted]";
};
com.cognitect.transit.types.quoted = function(a) {
  return new com.cognitect.transit.types.Quote(a);
};
com.cognitect.transit.types.isQuoted = function(a) {
  return a instanceof com.cognitect.transit.types.Quoted;
};
...
com.cognitect.transit.types.list = function(a) {
  return new com.cognitect.transit.types.List(a);
};
com.cognitect.transit.types.isList = function(a) {
  return a instanceof com.cognitect.transit.types.List;
};
com.cognitect.transit.types.Link = function(a) {
  this.rep = a;
};
com.cognitect.transit.types.link = function(a) {
  return new com.cognitect.transit.types.Link(a);
};
com.cognitect.transit.types.isLink = function(a) {
  return a instanceof com.cognitect.transit.types.Link;
};
com.cognitect.transit.caching = {};
com.cognitect.transit.caching.MIN_SIZE_CACHEABLE = 3;
com.cognitect.transit.caching.CACHE_CODE_NUMERALS = 94;
com.cognitect.transit.caching.MAX_CACHE_ENTRIES = 8836;
com.cognitect.transit.caching.BASE_CHAR_IDX = 33;
...
com.cognitect.transit.caching.idxToCode = function(a) {
  var b = Math.floor(a / com.cognitect.transit.caching.CACHE_CODE_NUMERALS);
  a = String.fromCharCode(a % com.cognitect.transit.caching.CACHE_CODE_NUMERALS + com.cognitect.transit.caching.BASE_CHAR_IDX);
...
com.cognitect.transit.caching.codeToIdx = function(a) {
  ...
  var b = (a.charCodeAt(1) - com.cognitect.transit.caching.BASE_CHAR_IDX) * com.cognitect.transit.caching.CACHE_CODE_NUMERALS;
...
com.cognitect.transit.impl.decoder.Decoder = function(a) {
  ...
  for (b in this.options.handlers) {
    if (com.cognitect.transit.impl.decoder.isGroundHandler(b)) {
      throw Error("Cannot override handler for ground types");
    }
...
com.cognitect.transit.impl.decoder.Decoder.prototype.defaults = {handlers:{_:function(a) {
  ...
  return com.cognitect.transit.types.ints(a);
}, longs:function(a) {
  return com.cognitect.transit.types.longs(a);
}, floats:function(a) {
  return com.cognitect.transit.types.floats(a);
}, doubles:function(a) {
  return com.cognitect.transit.types.doubles(a);
}, bools:function(a) {
  return com.cognitect.transit.types.bools(a);
}, cmap:function(a) {
...
com.cognitect.transit.impl.decoder.Decoder.prototype.decodeHash = function(a, b, c, d) {
  ...
  if (null != d && "string" === typeof d && d.charAt(0) === com.cognitect.transit.delimiters.ESC && d.charAt(1) === com.cognitect.transit.delimiters.TAG) {
    return a = a[e], c = this.handlers[d.substring(2)], null != c ? c(this.decode(a, b, !1, !0)) : com.cognitect.transit.types.taggedValue(d.substring(2), this.decode(a, b, !1, !1));
  }
  if (this.mapBuilder) {
    if (c.length < 2 * com.cognitect.transit.types.SMALL_ARRAY_MAP_THRESHOLD && this.mapBuilder.fromArray) {
      ...
      return this.mapBuilder.fromArray(f);
    }
    f = this.mapBuilder.init();
    for (d = 0;d < c.length;d++) {
      e = c[d], f = this.mapBuilder.add(f, this.decode(e, b, !0, !1), this.decode(a[e], b, !1, !1));
    }
    return this.mapBuilder.finalize(f);
  }
  f = [];
  for (d = 0;d < c.length;d++) {
    e = c[d], f.push(this.decode(e, b, !0, !1)), f.push(this.decode(a[e], b, !1, !1));
...
com.cognitect.transit.impl.decoder.Decoder.prototype.decodeArrayHash = function(a, b, c, d) {
  if (this.mapBuilder) {
    if (a.length < 2 * com.cognitect.transit.types.SMALL_ARRAY_MAP_THRESHOLD + 1 && this.mapBuilder.fromArray) {
      ...
      return this.mapBuilder.fromArray(d);
    }
    d = this.mapBuilder.init();
    for (c = 1;c < a.length;c += 2) {
      d = this.mapBuilder.add(d, this.decode(a[c], b, !0, !1), this.decode(a[c + 1], b, !1, !1));
    }
    return this.mapBuilder.finalize(d);
  }
  d = [];
  for (c = 1;c < a.length;c += 2) {
    d.push(this.decode(a[c], b, !0, !1)), d.push(this.decode(a[c + 1], b, !1, !1));
...
com.cognitect.transit.impl.decoder.Decoder.prototype.decodeArray = function(a, b, c, d) {
  if (d) {
    ...
    for (var e = 0;e < a.length;e++) {
      d.push(this.decode(a[e], b, c, !1));
    }
    return d;
  }
  if (this.arrayBuilder) {
    d = this.arrayBuilder.init();
    for (e = 0;e < a.length;e++) {
      d = this.arrayBuilder.add(d, this.decode(a[e], b, c, !1));
    }
    return this.arrayBuilder.finalize(d);
  }
  d = [];
  for (e = 0;e < a.length;e++) {
    d.push(this.decode(a[e], b, c, !1));
...
com.cognitect.transit.handlers.ctorGuidProperty = "com$cognitect$transit$ctor$guid";
com.cognitect.transit.handlers.typeTag = function(a) {
  ...
  null == b && (a[com.cognitect.transit.handlers.ctorGuidProperty] = b = ++com.cognitect.transit.handlers.ctorGuid);
  return b;
};
...
com.cognitect.transit.handlers.BigIntegerHandler = function() {
};
com.cognitect.transit.handlers.BigIntegerHandler.prototype.tag = function(a) {
  return "n";
};
com.cognitect.transit.handlers.BigIntegerHandler.prototype.rep = function(a) {
  return a.value;
};
com.cognitect.transit.handlers.BigIntegerHandler.prototype.stringRep = function(a) {
  return a.value;
};
com.cognitect.transit.handlers.BigDecimalHandler = function() {
};
com.cognitect.transit.handlers.BigDecimalHandler.prototype.tag = function(a) {
  return "f";
};
com.cognitect.transit.handlers.BigDecimalHandler.prototype.rep = function(a) {
  return a.value;
};
com.cognitect.transit.handlers.BigDecimalHandler.prototype.stringRep = function(a) {
  return a.value;
};
...
com.cognitect.transit.handlers.BinaryHandler = function() {
};
com.cognitect.transit.handlers.BinaryHandler.prototype.tag = function(a) {
  return "b";
};
com.cognitect.transit.handlers.BinaryHandler.prototype.rep = function(a) {
  return a.str;
};
com.cognitect.transit.handlers.BinaryHandler.prototype.stringRep = function(a) {
  return a.str;
};
...
com.cognitect.transit.handlers.URIHandler = function() {
};
com.cognitect.transit.handlers.URIHandler.prototype.tag = function(a) {
  return "r";
};
com.cognitect.transit.handlers.URIHandler.prototype.rep = function(a) {
  return a.uri;
};
com.cognitect.transit.handlers.URIHandler.prototype.stringRep = function(a) {
  return a.uri;
};
...
com.cognitect.transit.handlers.QuoteHandler = function() {
};
com.cognitect.transit.handlers.QuoteHandler.prototype.tag = function(a) {
  return "'";
};
com.cognitect.transit.handlers.QuoteHandler.prototype.rep = function(a) {
  return a.obj;
};
com.cognitect.transit.handlers.QuoteHandler.prototype.stringRep = function(a, b) {
  return null;
};
...
com.cognitect.transit.handlers.ListHandler = function() {
};
com.cognitect.transit.handlers.ListHandler.prototype.tag = function(a) {
  return "list";
};
com.cognitect.transit.handlers.ListHandler.prototype.rep = function(a) {
  return com.cognitect.transit.types.taggedValue("array", a.arr);
};
com.cognitect.transit.handlers.ListHandler.prototype.stringRep = function(a) {
  return null;
};
com.cognitect.transit.handlers.LinkHandler = function() {
};
com.cognitect.transit.handlers.LinkHandler.prototype.tag = function(a) {
  return "link";
};
com.cognitect.transit.handlers.LinkHandler.prototype.rep = function(a) {
  return com.cognitect.transit.types.taggedValue("map", a.rep);
};
com.cognitect.transit.handlers.LinkHandler.prototype.stringRep = function(a) {
  return null;
};
com.cognitect.transit.handlers.defaultHandlers = function(a) {
  ...
  a.set(com.cognitect.transit.types.BigInteger, new com.cognitect.transit.handlers.BigIntegerHandler);
  a.set(com.cognitect.transit.types.BigDecimal, new com.cognitect.transit.handlers.BigDecimalHandler);
  ...
  a.set(com.cognitect.transit.types.Binary, new com.cognitect.transit.handlers.BinaryHandler);
  a.set(com.cognitect.transit.types.UUID, new com.cognitect.transit.handlers.UUIDHandler);
  a.set(com.cognitect.transit.types.URI, new com.cognitect.transit.handlers.URIHandler);
  ...
  a.set(com.cognitect.transit.types.Quote, new com.cognitect.transit.handlers.QuoteHandler);
  ...
  a.set(com.cognitect.transit.types.List, new com.cognitect.transit.handlers.ListHandler);
  return a;
};
...
com.cognitect.transit.handlers.Handlers.prototype.get = function(a) {
  return this.handlers[com.cognitect.transit.handlers.typeTag(a)];
};
com.cognitect.transit.handlers.Handlers.prototype.set = function(a, b) {
  this.handlers[com.cognitect.transit.handlers.typeTag(a)] = b;
};
com.cognitect.transit.stringbuilder = {};
com.cognitect.transit.stringbuilder.StringBuilder = function() {
  this.buffer = "";
};
com.cognitect.transit.stringbuilder.StringBuilder.prototype.write = function(a) {
  this.buffer += a;
};
com.cognitect.transit.stringbuilder.StringBuilder.prototype.flush = function() {
  var a = this.buffer;
  this.buffer = "";
  return a;
};
...
com.cognitect.transit.impl.writer.escape = function(a) {
  if (0 < a.length) {
    var b = a.charAt(0);
    return b === com.cognitect.transit.delimiters.RES && a.charAt(1) === com.cognitect.transit.delimiters.ESC ? a.substring(1) : b === com.cognitect.transit.delimiters.ESC || b === com.cognitect.transit.delimiters.SUB || b === com.cognitect.transit.delimiters.RES ? com.cognitect.transit.delimiters.ESC + a : a;
  }
  return a;
};
com.cognitect.transit.impl.writer.JSONMarshaller = function(a) {
  this.opts = a || {};
  this.buffer = this.opts.buffer || new com.cognitect.transit.stringbuilder.StringBuilder;
...
com.cognitect.transit.impl.writer.JSONMarshaller.prototype.handler = function(a) {
  return this.handlers.get(com.cognitect.transit.handlers.constructor(a));
};
...
com.cognitect.transit.impl.writer.JSONMarshaller.prototype.emitQuoted = function(a, b) {
  var c = {}, d = this.emitString(com.cognitect.transit.delimiters.ESC_TAG, "'", "", !0, b);
  c[d] = com.cognitect.transit.impl.writer.marshal(this, a, !1, b);
  return c;
};
com.cognitect.transit.impl.writer.emitInts = function(a, b, c) {
  for (var d = [], e = 0;e < b.length;e++) {
    d.push(a.emitInt(a, b[e], !1, c));
  }
  return d;
};
com.cognitect.transit.impl.writer.emitShorts = function(a, b, c) {
  for (var d = [], e = 0;e < b.length;e++) {
    d.push(a.emitShort(a, b[e], !1, c));
  }
  return d;
};
com.cognitect.transit.impl.writer.emitLongs = function(a, b, c) {
  for (var d = [], e = 0;e < b.length;e++) {
    d.push(a.emitInt(a, b[e], !1, c));
  }
  return d;
};
com.cognitect.transit.impl.writer.emitFloats = function(a, b, c) {
  for (var d = [], e = 0;e < b.length;e++) {
    d.push(a.emitFloat(a, b[e], !1, c));
  }
  return d;
};
com.cognitect.transit.impl.writer.emitDouble = function(a, b, c) {
  for (var d = [], e = 0;e < b.length;e++) {
    d.push(a.emitDouble(a, b[e], !1, c));
  }
  return d;
};
com.cognitect.transit.impl.writer.emitChars = function(a, b, c) {
  for (var d = [], e = 0;e < b.length;e++) {
    d.push(com.cognitect.transit.impl.writer.marshal(a, b[e], !1, c));
  }
  return d;
};
com.cognitect.transit.impl.writer.emitBooleans = function(a, b, c) {
  for (var d = [], e = 0;e < b.length;e++) {
    d.push(a.emitBoolean(a, b[e], !1, c));
  }
  return d;
};
...
com.cognitect.transit.impl.writer.stringableKeys = function(a, b) {
  ...
  if (c) {
    ...
    for (c = b.keySet(), e = 0;e < c.length && (d = com.cognitect.transit.impl.writer.isStringableKey(a, c[e]), d);e++) {
    }
  }
  return d;
};
com.cognitect.transit.impl.writer.emitMap = function(a, b, c, d) {
  ...
  c.data = {obj:b, type:com.cognitect.transit.handlers.constructor(b).name};
  throw c;
};
com.cognitect.transit.impl.writer.emitTaggedMap = function(a, b, c, d, e) {
  d = {};
  d[a.emitString(com.cognitect.transit.delimiters.ESC_TAG, b, "", !0, e)] = com.cognitect.transit.impl.writer.marshal(a, c, !1, e);
  return d;
};
com.cognitect.transit.impl.writer.emitEncoded = function(a, b, c, d, e, f, g) {
  if (1 === c.length) {
    ...
    if (f || a.preferStrings) {
      ...
      a = Error("Cannot be encoded as string");
...
com.cognitect.transit.impl.writer.marshal = function(a, b, c, d) {
  ...
  if (null != e && null != f) {
    ...
    throw a = Error("Not supported"), a.data = {obj:b, type:com.cognitect.transit.handlers.constructor(b).name}, a;
  }
};
...
com.cognitect.transit.impl.writer.Writer.prototype.write = function(a, b) {
  ...
  cache = this._marshaller.verbose ? !1 : this.cache;
  c = !1 === c.marshalTop ? com.cognitect.transit.impl.writer.marshal(this._marshaller, a, asMapKey, cache) : com.cognitect.transit.impl.writer.marshalTop(this._marshaller, a, asMapKey, cache);
...
var TRANSIT_NODE_TARGET = !1, TRANSIT_BROWSER_TARGET = !0;
...
com.cognitect.transit.isInteger = com.cognitect.transit.types.intValue;
...
com.cognitect.transit.isBigDecimal = com.cognitect.transit.types.isBigDecimal;
...
com.cognitect.transit.types.isInteger), goog.exportSymbol("transit.uuid", com.cognitect.transit.types.uuid), goog.exportSymbol("transit.isUUID", com.cognitect.transit.types.isUUID), goog.exportSymbol("transit.bigdec", com.cognitect.transit.types.bigDecimalValue), goog.exportSymbol("transit.isBigDecimal", com.cognitect.transit.types.isBigDecimal), goog.exportSymbol("transit.keyword", com.cognitect.transit.types.keyword), goog.exportSymbol("transit.isKeyword", com.cognitect.transit.types.isKeyword), 
goog.exportSymbol("transit.symbol", com.cognitect.transit.types.symbol), goog.exportSymbol("transit.isSymbol", com.cognitect.transit.types.isSymbol), goog.exportSymbol("transit.binary", com.cognitect.transit.types.binary), goog.exportSymbol("transit.isBinary", com.cognitect.transit.types.isBinary), goog.exportSymbol("transit.uri", com.cognitect.transit.types.uri), goog.exportSymbol("transit.isURI", com.cognitect.transit.types.isURI), goog.exportSymbol("transit.map", com.cognitect.transit.types.map), 
goog.exportSymbol("transit.isMap", com.cognitect.transit.types.isMap), goog.exportSymbol("transit.set", com.cognitect.transit.types.set), goog.exportSymbol("transit.isSet", com.cognitect.transit.types.isSet), goog.exportSymbol("transit.list", com.cognitect.transit.types.list), goog.exportSymbol("transit.isList", com.cognitect.transit.types.isList), goog.exportSymbol("transit.quoted", com.cognitect.transit.types.quoted), goog.exportSymbol("transit.isQuoted", com.cognitect.transit.types.isQuoted), 
goog.exportSymbol("transit.tagged", com.cognitect.transit.types.taggedValue), goog.exportSymbol("transit.isTaggedValue", com.cognitect.transit.types.idTaggedValue), goog.exportSymbol("transit.link", com.cognitect.transit.types.link), goog.exportSymbol("transit.isLink", com.cognitect.transit.types.isLink), goog.exportSymbol("transit.hash", com.cognitect.transit.eq.hashCode), goog.exportSymbol("transit.equals", com.cognitect.transit.eq.equals), goog.exportSymbol("transit.extendToEQ", com.cognitect.transit.eq.extendToEQ), 
...
TRANSIT_NODE_TARGET && (module.exports = {reader:com.cognitect.transit.reader, writer:com.cognitect.transit.writer, makeBuilder:com.cognitect.transit.makeBuilder, makeWriteHandler:com.cognitect.transit.makeWriteHandler, date:com.cognitect.transit.types.date, integer:com.cognitect.transit.types.intValue, isInteger:com.cognitect.transit.types.isInteger, uuid:com.cognitect.transit.types.uuid, isUUID:com.cognitect.transit.types.isUUID, bigdec:com.cognitect.transit.types.bigDecimalValue, isBigDecimal:com.cognitect.transit.types.isBigDecimal, 
keyword:com.cognitect.transit.types.keyword, isKeyword:com.cognitect.transit.types.isKeyword, symbol:com.cognitect.transit.types.symbol, isSymbol:com.cognitect.transit.types.isSymbol, binary:com.cognitect.transit.types.binary, isBinary:com.cognitect.transit.types.isBinary, uri:com.cognitect.transit.types.uri, isURI:com.cognitect.transit.types.isURI, map:com.cognitect.transit.types.map, isMap:com.cognitect.transit.types.isMap, set:com.cognitect.transit.types.set, isSet:com.cognitect.transit.types.isSet, 
list:com.cognitect.transit.types.list, isList:com.cognitect.transit.types.isList, quoted:com.cognitect.transit.types.quoted, isQuoted:com.cognitect.transit.types.isQuoted, tagged:com.cognitect.transit.types.taggedValue, isTaggedValue:com.cognitect.transit.types.isTaggedValue, link:com.cognitect.transit.types.link, isLink:com.cognitect.transit.types.isLink, hash:com.cognitect.transit.eq.hashCode, equals:com.cognitect.transit.eq.equals, extendToEQ:com.cognitect.transit.eq.extendToEQ, mapToObject:com.cognitect.transit.mapToObject, 
decoder:com.cognitect.transit.impl.decoder.decoder, UUIDfromString:com.cognitect.transit.types.UUIDfromString, randomUUID:com.cognitect.transit.types.randomUUID, stringableKeys:com.cognitect.transit.impl.writer.stringableKeys});
